																		...
																		<tbody>
																			@if($informations)
																				...
																				<tr>
																					...
																					<td class="pl-0">
																						<a href="{{url('administration/teacher/workspace/view/'.$information['id'])}}"  class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">{{$information['Title']}}</a>
																				...
																				@endforeach
																			@else
																			<center><h3>No existen publicaciones disponibles</h3></center>
																			<br><br><br>
																			@endif
