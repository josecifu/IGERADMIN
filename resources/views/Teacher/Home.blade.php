                                            ...
                                            <div class="card-header border-0 pt-5">
                                                ...
                                                <div class="card-toolbar">
                                                    <ul class="nav nav-pills nav-pills-sm nav-dark-75">
                                                        <li class="nav-item">
                                                            <a class="nav-link py-2 px-4 active font-weight-bolder" data-toggle="tab" href="#kt_tab_pane_10_2">Próximos</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                                                ...
                                                                <tbody>
                                                                   @foreach($tests as $t)
                                                                    <tr>
                                                                        ...
                                                                        <td class="text-left">
                                                                            <span class="text-dark-75 font-weight-bolder d-block font-size-lg">{{$t['FF']}}</span>
                                                                            <span class="text-muted font-weight-bold d-block font-size-sm">Fecha Final</span>
                                                                        </td>
                                                                    </tr>
                                                                    @endforeach
                                                                </tbody>
