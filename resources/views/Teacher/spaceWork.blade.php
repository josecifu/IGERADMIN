												...
												<div class="d-flex justify-content-between flex-column h-100">
													...
													<div class="h-100">
														...
														<div class="d-flex flex-column flex-center">
															...
															<!--end::Image-->
															<!--begin::Title-->
															<a href="#" class="card-title font-weight-bolder text-dark-75 text-hover-primary font-size-h4 m-0 pt-7 pb-1">Curso {{$info['curso']}}</a>
															<!--end::Title-->
															<!--begin::Text-->
															<div class="font-weight-bold text-dark-50 font-size-sm pb-7">{{$info['Period']}}, {{$teacher->Names}}</div>
															<!--end::Text-->
														</div>
														<!--end::Header-->
														<!--begin::Body-->
														<div class="pt-1">
															...
															<div class="d-flex align-items-center pb-9">
																...
																<div class="d-flex flex-column flex-grow-1">
																	...
																	<span class="text-muted font-weight-bold">No. estudiantes asignados </span>
																</div>
																<!--end::Text-->
																<!--begin::label-->
																<span class="font-weight-bolder label label-xl label-light-danger label-inline px-3 py-5 min-w-45px">{{$info['Students']}}</span>
																<!--end::label-->
															</div>
															<!--end::Item-->
															<!--begin::Item-->
															<div class="d-flex align-items-center pb-9">
																...
																<div class="d-flex flex-column flex-grow-1">
																	...
																	<span class="text-muted font-weight-bold">No. Examenes</span>
																</div>
																<!--end::Text-->
																<!--begin::label-->
																<span class="font-weight-bolder label label-xl label-light-primary label-inline py-5 min-w-45px">{{$info['Tests']}}</span>
																<!--end::label-->
															</div>
															<!--end::Item-->
														</div>
													...
													<div class="d-flex flex-center" id="kt_sticky_toolbar_chat_toggler_3" data-toggle="tooltip" title="" data-placement="right" data-original-title="Chat Example">
														<button class="btn btn-primary font-weight-bolder font-size-sm py-3 px-14" onclick="actualizar();">Datos Voluntario</button>
													</div>
													<!--end::Footer-->
												</div>
												<!--end::Wrapper-->
