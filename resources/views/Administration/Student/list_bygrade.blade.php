    ...
    @section('scripts')
        ...
        <script type="text/javascript">
            ...
            function exportdata(Type)
            {
                ...
                var $url_path = '{!! url('/') !!}';
                if(Type==1)
                window.location.href = $url_path+"/reports/pdf/{{$id}}/listadoalumnosgrado1";
                if(Type==2)
                window.location.href = $url_path+"/reports/pdf/{{$id}}/listadoalumnosgrado2";
                if(Type==3)
                window.location.href = $url_path+"/reports/pdf/{{$id}}/listadoalumnosgrado3";
