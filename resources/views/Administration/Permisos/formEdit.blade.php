...
{{-- Page title --}}
                                        ...
                                        <form class="form" id="kt_form" >
                                            <div class="row">
                                                ...
                                                <div class="col-xl-8">
                                                    ...
                                                    <div class="my-5">
                                                        <h3 class="text-dark font-weight-bold mb-10">Detalle Permiso:</h3>
                                                        <div class="form-group row">
                                                            <label class="col-3">Nombre del permiso</label>
                                                            <div class="col-9">
                                                                <div class="input-group input-group-solid">
                                                                    <input type="text" id="Permiso" value="{{$Model->Name}}" class="form-control form-control-solid" placeholder="Nombre" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-9">
                                                                <div class="input-group input-group-solid">
                                                                    <input type="text" id="Slug" value="{{$Model->Slug}}" class="form-control form-control-solid" placeholder="Slug" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
    ...
    <script type="text/javascript">
         ...
         function crearDatos()
         {
            ...
            $.ajax({
                url:'/actualizar/permiso/{{$Model->id}}',
                type:'POST',
