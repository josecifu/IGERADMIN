                                    ...
                                    <div class="card-header">
                                        ...
                                        <div class="card-toolbar">
                                            ...
                                            <div class="btn-group">
                                                ...
                                                <i class="ki ki-check icon-sm"></i>Guardar Horario</button>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form class="form" id="kt_form" >
                                            <div class="row">
                                                ...
                                                <div class="col-xl-8">
                                                    <div class="my-5">
                                                        <h3 class="text-dark font-weight-bold mb-10">Información del Horario:</h3>
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-9">
                                                                <div class="input-group input-group-solid">
                                                                    ...
                                                                    <input type="text" id="HoraInicio" class="form-control form-control-solid" placeholder="Inicio" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-9">
                                                                <div class="input-group input-group-solid">
                                                                    ...
                                                                    <input type="text" id="HoraFinal" class="form-control form-control-solid" placeholder="Final" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-9">
                                                                <div class="input-group input-group-solid">
                                                                    ...
                                                                    <input type="text" id="Dia" class="form-control form-control-solid" placeholder="Dia" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-9">
                                                                <div class="input-group input-group-solid">
                                                                    ...
                                                                    <input type="text" id="Tipo" class="form-control form-control-solid" placeholder="Tipo" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
         ...
         function crearDatos()
         {
            ...
            $.ajax({
                ...
                swal.fire({ title: "Accion completada", 
                  text: "Se ha registrado el nuevo horario!", 
                  type: "success"
                        }).then(function () {
                          var $url_path = '{!! url('/') !!}';
