                        ...
                        <div class="card card-custom gutter-b">
                            ...
                            <div class="card-header border-0 pt-5">
                                <h3 class="card-title align-items-start flex-column">
                                    ...
                                    <span class="text-muted mt-3 font-weight-bold font-size-sm">Todos los examenes de: 
                                    <span class="text-primary">Semestre 1</span></span>
                                </h3>
                            </div>
                            <!--end::Header-->
                            <!--begin::Body-->
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td class="pl-0">
                                                            ...
                                                            <span class="text-muted font-weight-bold d-block">Matemáticas</span>
                                                        </td>
                                                        <td></td>
                                                        <td class="text-left">
                                                            <span class="text-dark-75 font-weight-bolder d-block font-size-lg">3 de Abril de 2021, 3:00 PM</span>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td></td>
                                                        <td class="text-left">
                                                            <span class="text-dark-75 font-weight-bolder d-block font-size-lg">4 de Abril de 2021, 3:30 PM</span>
                                                            <span class="text-muted font-weight-bold d-block font-size-sm">Fecha & Hora</span>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td></td>
                                                        <td class="text-left">
                                                            <span class="text-dark-75 font-weight-bolder d-block font-size-lg">27 de Julio de 2021, 2:30 PM</span>
                                                            <span class="text-muted font-weight-bold d-block font-size-sm">Fecha & Hora</span>
                                                        </td>
                                                    </tr>
                                                </tbody>
