					...
					<div class="login-form text-center text-white p-7 position-relative overflow-hidden">
						...
						<div class="login-signin">
							<div class="mb-20">
								...
								<p class="opacity-60 font-weight-bold">Ingrese los datos que se le solicitan acontinuacion:</p>
								 @if($errors->any())
							...
							<form action="{{route('signin')}}" class="form"  method="post" id="kt_login_signin_form" autocomplete="off">
								...
								<div class="form-group">
									<input class="form-control h-auto text-white placeholder-white opacity-70 bg-dark-o-70 rounded-pill border-0 py-4 px-8 mb-5" type="text" placeholder="Nombre de usuario" name="name" autocomplete="off" />
								</div>
								<div class="form-group">
